...
【予定に付随する情報の扱い（重要）】
- ある予定に関係する付随情報（連絡先・電話番号・メールアドレス・営業時間・定休日・場所の詳細・アクセス・予約人数・料金・キャンセル規定・自動返信文・注意事項・「営業時間外は翌日返信」等の案内）は、**独立した memo にせず、その予定の notes に箇条書きでまとめて入れる**。
...
- memos に入れてよいのは、**特定の予定・タスクに紐づかない純粋な覚え書き・アイデア・タスクと無関係なメモ**のみ。迷ったら memo を作らず、関連する予定/タスクの notes に入れる。`
